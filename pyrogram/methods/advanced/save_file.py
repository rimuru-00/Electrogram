    ...
    async def save_file(
        ...
        async with self.save_file_semaphore:
                    ...
                    for attempt in range(3):
                        try:
                            ...
                            if attempt < 2:
                                ...
                                log.exception(f"Failed after 3 attempts: {e}")

            async def preload(fp, part_size):
            ...
            try:
                ...
                next_chunk_task = self.loop.create_task(preload(fp, part_size))
                ...
                log.exception(f"Error during file upload at part {file_part}: {e}")
            else:
                if is_big:
